This repository contains code for a machine learning model designed to predict the solubility class of compounds by generating and evaluating chemical descriptors.
